...
- [ ] **Screenshots** — Uncomment the `<screenshots>` block and add real images at stable raw GitHub URLs. The first entry must carry `type="default"`; that is what software centers feature. Needs `data/screenshots/` created and populated.

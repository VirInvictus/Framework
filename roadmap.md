...
### Reviewed
- `fw-document-pdf.c` — clean: threading model, `fz_try/catch` discipline, `fz_cookie` cancellation (real cache path), stext LRU cache, dispose/finalize ordering all sound.
...
- [ ] MED — Em-dash ban: 348 rendered violations (roadmap 152 bold-label separators, README 68 incl. &mdash; entities, CLAUDE.md 47, foliate-rewrite 47, spec 29); plus slop kills: "Best-in-Class UX" Phase-14 tagline, "Leveraging", "Seamless Auto-Reload", "marquee delivery", "design north star", "utilizing", "seamless" duplicated across README/roadmap, "core performance differentiator" duplicated spec/CLAUDE.
